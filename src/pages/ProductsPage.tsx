...
const productImageMappings: { [key: string]: string } = {
  ...
  'xk315-field-scale': '/images/XK315.jpg',
  'CLASS 1 - Steel Weighbridge SBP/M Model': '/images/weighbridge A.jpg',
  'class1-steel-weighbridge-sbp-m': '/images/weighbridge A.jpg',
  'Steel Weighbridge SBP/M Model': '/images/weighbridge A.jpg',
