...
const steps: readonly Step[] = [
  {
    ...
    description: "Expert installation and configuration services for all weighing solutions. Our certified technicians ensure proper setup, calibration, and compliance with local regulations including OIML standards.",
  },
  {
    id: "2",
    name: "Step 2", 
    title: "24/7 Technical Support",
    description: "Round-the-clock technical support and maintenance services across East Africa. Emergency response teams, remote diagnostics, and on-site assistance to keep your operations running smoothly.",
  },
  {
    id: "3",
    name: "Step 3",
    title: "Training & Certification",
    description: "Comprehensive training programs for your team including operator training, maintenance staff certification, safety protocols, and custom training modules tailored to your industry needs.",
  },
  {
    id: "4",
    name: "Step 4",
    title: "Custom Solutions",
    description: "Tailored weighing solutions designed to meet specific business requirements. From system integration to specialized applications, we deliver scalable solutions that grow with your business.",
  },
  {
    id: "5",
    name: "Step 5",
    title: "Maintenance Services",
    description: "Comprehensive maintenance services to ensure optimal performance. Preventive maintenance programs, regular calibration services, performance optimization, and scheduled service visits.",
  },
  {
    id: "6",
    name: "Step 6",
    title: "On-Site Services",
    description: "On-site support and service for all locations. Mobile service units, field service technicians, emergency response teams, and regional service coverage with rapid response guarantee.",
  },
]
      ...
      <div className="relative w-full overflow-hidden rounded-3xl border border-neutral-200 bg-white transition-colors duration-300 dark:border-neutral-800 dark:bg-neutral-900">
        <div className="m-10 min-h-[450px] w-full">
          <AnimatePresence mode="wait">
            ...
            >
              <motion.div
                className="text-sm font-semibold uppercase tracking-wider text-red-600 dark:text-red-500"
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: 1, x: 0 }}
                    ...
                    return (
                        <motion.li key={step.name} initial="inactive" animate={isCurrent ? "active" : "inactive"} variants={stepVariants} transition={{ duration: 0.3 }} className="relative" >
                            <button
                                type="button"
                                className={cn(
                                    "group flex items-center gap-2.5 rounded-full px-3.5 py-1.5 text-sm font-medium transition-colors duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-red-500 dark:focus-visible:ring-offset-black",
                                    isCurrent 
                            ...
                            >
                                <span className={cn(
                                    ...
                                    isCompleted 
                                        ? "bg-red-600 text-white dark:bg-red-500" 
                                        : isCurrent 
                                            ? "bg-red-400 text-red-900 dark:bg-red-400 dark:text-red-900" 
